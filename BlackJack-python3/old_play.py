...
class Game:
    def __init__(self, shoe, dealer, players, countStrategy, infoWriter, historyWriter, dataWriter, shoe_num,
                 trails_num):
        self.shoe = shoe
        self.dealer = dealer
        self.players = players
        self.countStrategy = countStrategy
    ...
    def __init__(self, shoe, dealer, players, countStrategy, infoWriter, historyWriter, shoe_num, trails_num):
        self.shoe = shoe
        self.dealer = dealer
        self.players = players
        self.countStrategy = countStrategy
    ...
    def play(self):
        ...
        while self.i < self.shoe_num * 52 - 20:
            ...
            print(count+1)
            self.historyWriter.write(count+1 + ',')
            self.write_count()
